...
export const translations: Record<Language, Translation> = {
  es: {
    ...
    'hero.cta.main': 'Contrata tu servicio de lujo',
    'hero.cta.whatsapp': 'WhatsApp',
    'cta.services.title': '¿Listo para tu experiencia de lujo?',
    'cta.services.subtitle': 'Transforma tu visita a Ibiza en una experiencia inolvidable. Contáctanos ahora y empieza a disfrutar.',
    'cta.services.button': 'Contactar ahora',
    'cta.about.title': '¿Preparado para vivir Ibiza sin límites?',
    'cta.about.subtitle': 'Nuestro equipo de expertos está listo para hacer realidad tus sueños en Ibiza. Contacta ahora y empieza tu aventura.',
    'cta.about.button': 'Empezar ahora',
    ...
    'about.subtitle': 'Historia personal y experiencia en Ibiza.',
    'about.description': '<p>Mi nombre es Iván, nací en Madrid dentro de una familia humilde de trabajadores y crecí rodeado de valores como el esfuerzo, la lealtad y la disciplina. Con tres hermanos y unos padres obreros aprendí desde muy joven que las grandes oportunidades no se esperan: se buscan.</p><p>Hace más de veinte años llegué a Ibiza con un objetivo claro: construir un futuro diferente. Comencé trabajando en la seguridad de discotecas hasta formar parte de la dirección de seguridad del club La Plage, junto a mi socio y gran amigo Lorenzo. Aquella experiencia fue el punto de partida que nos abrió las puertas al mundo del alto nivel: trabajamos para clientes de prestigio, acompañamos a artistas y DJs internacionales —entre ellos Marco Carola, con quien colaboramos durante más de 12 años— y entramos en contacto directo con los lugares y experiencias más exclusivas de la isla.</p><p>Con el tiempo nos especializamos también en el sector concierge: organización de vacaciones a medida, mesas VIP en los clubs más importantes, reservas en restaurantes top, alquiler de villas de lujo, yates, fiestas privadas y atención personal para clientes que buscan privacidad, excelencia y detalle.</p><p>No todo en el camino fue fácil. Hubo proyectos que no funcionaron como esperábamos y también momentos personales duros, entre ellos la pérdida de mi socio, que marcó una etapa complicada. Sin embargo, esa experiencia me fortaleció, y también redefinió mi manera de trabajar y de ver este negocio.</p><p>Hoy continúo combinando mi experiencia en seguridad privada con el servicio de concierge, trabajando únicamente con equipos y profesionales de la máxima confianza. Somos un grupo reducido de amigos y colaboradores de verdad, que cuidamos de cada cliente de forma cercana, discreta y profesional. Nuestra misión es simple: que cada persona que llega a Ibiza viva una experiencia inolvidable, segura y única.</p>',
    ...
    'faq.q3': '¿Con cuánto tiempo debo reservar?',
    'faq.a3': 'No requerimos un tiempo específico de anticipación. Lo ideal es contactarnos lo antes posible para garantizar la mejor disponibilidad, pero también atendemos solicitudes urgentes o de última hora, adaptándonos a tus necesidades en cualquier momento.',
    
    'faq.q4': '¿Cómo se realiza el pago?',
    'faq.a4': 'Nos adaptamos a la forma más cómoda para cada cliente. Habitualmente trabajamos con un 50% al iniciar y el resto al finalizar, aunque también ofrecemos la opción de pagar todo al final del servicio. Aceptamos distintos métodos de pago, incluido efectivo, para brindarte total comodidad y flexibilidad.',
    
    'faq.q5': '¿Qué pasa si necesito cancelar?',
    'faq.a5': 'Puedes cancelar sin problema. Con 15 días de antelación, los pagos realizados por transferencia se reembolsan al 100%. Con 7 días, se devuelve el 50%. En cancelaciones de último minuto, siempre intentamos ofrecer alternativas o soluciones, pero el reembolso no está garantizado, ya que depende del servicio contratado.',
  ...
  en: {
    ...
    'hero.cta.main': 'Hire your luxury service',
    'hero.cta.whatsapp': 'WhatsApp',
    'cta.services.title': 'Ready for your luxury experience?',
    'cta.services.subtitle': 'Transform your visit to Ibiza into an unforgettable experience. Contact us now and start enjoying.',
    'cta.services.button': 'Contact now',
    'cta.about.title': 'Ready to live Ibiza without limits?',
    'cta.about.subtitle': 'Our team of experts is ready to make your dreams in Ibiza come true. Contact now and start your adventure.',
    'cta.about.button': 'Start now',
    ...
    'faq.a3': 'We do not require a specific advance notice. Ideally, contact us as soon as possible to ensure the best availability, but we also handle urgent or last-minute requests, adapting to your needs at any time.',
    'faq.q4': 'How is payment made?',
    'faq.a4': 'We adapt to the most comfortable method for each client. We usually work with 50% upfront and the rest upon completion, although we also offer the option to pay everything at the end of the service. We accept different payment methods, including cash, to provide you with total comfort and flexibility.',
    'faq.q5': 'What if I need to cancel?',
    'faq.a5': 'You can cancel without any problem. With 15 days notice, payments made by transfer are refunded 100%. With 7 days notice, 50% is returned. For last-minute cancellations, we always try to offer alternatives or solutions, but the refund is not guaranteed as it depends on the contracted service.',
  ...
  ru: {
    ...
    'hero.cta.main': 'Закажите свой сервис премиум-класса',
    'hero.cta.whatsapp': 'WhatsApp',
    'cta.services.title': 'Готовы к роскошному опыту?',
    'cta.services.subtitle': 'Превратите свой визит в Ибицу в незабываемый опыт. Свяжитесь с нами сейчас и начните наслаждаться.',
    'cta.services.button': 'Связаться сейчас',
    'cta.about.title': 'Готовы жить в Ибице без ограничений?',
    'cta.about.subtitle': 'Наша команда экспертов готова воплотить ваши мечты на Ибице. Свяжитесь сейчас и начните свое приключение.',
    'cta.about.button': 'Начать сейчас',
    ...
    'faq.a3': 'Мы не требуем конкретного предварительного уведомления. В идеале свяжитесь с нами как можно скорее, чтобы обеспечить лучшую доступность, но мы также работаем с срочными или последними запросами, адаптируясь к вашим потребностям в любое время.',
    'faq.q4': 'Как осуществляется оплата?',
    'faq.a4': 'Мы адаптируемся к самому удобному способу для каждого клиента. Обычно мы работаем с 50% предоплатой и остатком после завершения, хотя также предлагаем вариант оплаты всей суммы в конце услуги. Мы принимаем различные способы оплаты, включая наличные, чтобы обеспечить вам полный комфорт и гибкость.',
    'faq.q5': 'Что, если мне нужно отменить?',
    'faq.a5': 'Вы можете отменить без проблем. При 15 днях предварительного уведомления платежи, сделанные переводом, возвращаются на 100%. При 7 днях возвращается 50%. При последних отменах мы всегда стараемся предложить альтернативы или решения, но возврат не гарантирован, так как это зависит от заказанной услуги.',
