...
export default function ContactForm() {
  ...
  if (isSuccess) {
    return (
      <div className="text-center py-8">
        <CheckCircle className="w-16 h-16 text-firstclass-primary mx-auto mb-4" />
        <h3 className="text-2xl font-bold mb-2 text-firstclass-text font-hero">{t('form.success.title')}</h3>
        <p className="text-firstclass-text/80">{t('form.success.message')}</p>
      </div>
    )
  }
  ...
  return (
    ...
    >
      <div>
        <label htmlFor="fullName" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.fullName')}
        </label>
        <input
          type="text"
          ...
          className="w-full px-4 py-2 border border-firstclass-primary/20 rounded-lg focus:ring-2 focus:ring-firstclass-primary focus:border-firstclass-primary bg-firstclass-light text-firstclass-text transition-colors placeholder-firstclass-text/30"
          aria-required="true"
      ...
      <div>
        <label htmlFor="email" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.email')}
        </label>
        <input
          type="email"
      ...
      <div>
        <label htmlFor="phone" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.phone')}
        </label>
        <input
          type="tel"
      ...
      <div>
        <label htmlFor="dates" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.dates')}
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="people" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.people')}
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="budget" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.budget')}
        </label>
        <input
          type="text"
      ...
      <div>
        <label htmlFor="services" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.services')}
        </label>
        <textarea
          id="services"
          ...
          className="w-full px-4 py-2 border border-firstclass-primary/20 rounded-lg focus:ring-2 focus:ring-firstclass-primary focus:border-firstclass-primary bg-firstclass-light text-firstclass-text transition-colors resize-none placeholder-firstclass-text/30"
          aria-required="true"
      ...
      <div>
        <label htmlFor="message" className="block text-sm font-medium text-firstclass-text/90 mb-1 font-body">
          {t('form.message')}
        </label>
        <textarea
          id="message"
      ...
      {error && (
        <div
          className="bg-red-900/20 border border-red-800 text-red-200 px-4 py-3 rounded-lg"
          role="alert"
          aria-live="assertive"
        >
          {error}
      ...
      <button
        ...
        className="w-full bg-firstclass-primary hover:bg-firstclass-secondary disabled:bg-firstclass-light text-firstclass-background font-semibold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2 disabled:cursor-not-allowed"
        aria-describedby={isSubmitting ? 'submit-status' : undefined}
      >
        {isSubmitting ? (
          <>
            <div className="w-5 h-5 border-2 border-firstclass-background border-t-transparent rounded-full animate-spin" aria-hidden="true"></div>
